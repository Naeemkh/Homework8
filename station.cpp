...
bool Event::set_nt_name(string nt_name1, int total_entry, ofstream& errorfile) {
...
bool Event::set_Ins_type(string Ins_type1, int total_entry,
                         ofstream& errorfile) {
...
bool Event::set_orientation(string orientation1, int total_entry,
                            ofstream& errorfile) {
